...
DATABASES = {
        ...
        #'default' : { 'ENGINE': 'django.db.backends.sqlite3', 'NAME':  '/home/arek/projects/goodcode_nv/goodcode.db'},
...
MEDIA_ROOT = '/home/arek/projects/goodcode_nv/image-server/'
...
STATIC_ROOT = '/home/arek/projects/goodcode_nv/image-server/static/'
...
#Configure logging
import logging
LOGFILE = "/home/arek/projects/goodcode_nv/goodcode.log"
...
logging.getLogger('photograph').setLevel(logging.INFO)
logging.getLogger('goodcode_nv.search').setLevel(logging.INFO)
# commend this off if you want to see db queries
logging.getLogger('django.db.backends').setLevel(logging.ERROR)
logging.info("Goodcode Started")
